...
public class FileUtils {
    ...
    public static boolean checkFileType(@NonNull String fileName, @NonNull String type) {
        ...
        if (isKitKat && DocumentsContract.isDocumentUri(context, uri)) {
            ...
            if (isExternalStorageDocument(uri)) {
                ...
                if ("primary".equalsIgnoreCase(type)) {
                    ...
                    return getUsbPath(context) + "/" + split[1];
                }
            }
            // DownloadsProvider
        ...
        if (device != null) {
            ...
            try {
                ...
                for (int i = 0; i < storageVolumeList.length; i++) {
                    ...
                    if (mountPoint.listFiles() != null && !mountPoint.getAbsolutePath().equals(Environment.getExternalStorageDirectory().getPath())) {
                        usbPath = mountPoint.getPath();
                    }
                }
